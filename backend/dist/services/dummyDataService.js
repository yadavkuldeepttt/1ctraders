...
exports.getAllDummyData = exports.generateDummyCrudeOilInvestments = exports.generateDummyGamingTokens = exports.generateDummyStocks = exports.generateDummyTrades = void 0;
// Dummy Trades Data
const generateDummyTrades = (count = 10) => {
...
exports.generateDummyTrades = generateDummyTrades;
// Dummy Stocks Data
...
exports.generateDummyStocks = generateDummyStocks;
// Dummy Gaming Tokens Data
const generateDummyGamingTokens = () => {
    const tokens = [
...
exports.generateDummyGamingTokens = generateDummyGamingTokens;
// Dummy Crude Oil Investments in Russia
const generateDummyCrudeOilInvestments = () => {
    const locations = [
...
exports.generateDummyCrudeOilInvestments = generateDummyCrudeOilInvestments;
// Get all dummy data
const getAllDummyData = () => {
    return {
        trades: (0, exports.generateDummyTrades)(20),
        stocks: (0, exports.generateDummyStocks)(),
        gamingTokens: (0, exports.generateDummyGamingTokens)(),
        crudeOilInvestments: (0, exports.generateDummyCrudeOilInvestments)(),
    };
};
exports.getAllDummyData = getAllDummyData;
//# sourceMappingURL=dummyDataService.js.map